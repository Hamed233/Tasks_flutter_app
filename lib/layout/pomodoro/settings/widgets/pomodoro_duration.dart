...
class PomodoroDurationWidget extends StatelessWidget {
          ...
          child: Container(
            ...
            child: ListView.separated(
              itemBuilder: (context, index) {
                return pomodoroBuilder(context, durations[index], pomoCubit.pomoSettings.work);
              },
  ...
  Widget pomodoroBuilder(context, duration, workDuration) {
    return Container(
      child: Padding(
        padding: const EdgeInsets.all(15.0),
        child: InkWell(
          onTap: () {
            PomodoroCubit.get(context).updatePomodoroSettings(context, CacheHelper.getData(key: "user_id"), "workDuration", duration: duration);
          },
          child: Row(
            children: [
              Text(
              ...
              Spacer(),
              if(duration.inMinutes == workDuration.inMinutes)
                Icon(
                  Icons.check,
                  color: mainColor,
                  size: 16,
