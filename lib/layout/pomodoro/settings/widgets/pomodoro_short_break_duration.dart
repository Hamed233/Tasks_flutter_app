...
class PomodoroShortBreakDurationWidget extends StatelessWidget {
          ...
          child: Container(
            ...
            child: ListView.separated(
              itemBuilder: (context, index) {
                return shortBreakBuilder(context, shortBreakDurations[index], pomoCubit.pomoSettings.shortBreak);
              },
              ...
              itemCount: shortBreakDurations.length,
            ),
          ),
          ),
      );
  ...
  Widget shortBreakBuilder(context, duration, shortBreak) {
    ...
    return Container(
      child: Padding(
        ...
        child: InkWell(
          onTap: () {
            PomodoroCubit.get(context).updatePomodoroSettings(context, CacheHelper.getData(key: "user_id"), "shortBreak", duration: duration);
          },
          child: Row(
            children: [
              Text(
              ...
              Spacer(),
              if(duration.inMinutes == shortBreak!.inMinutes)
                Icon(
                  Icons.check,
                  color: mainColor,
                  size: 16,
