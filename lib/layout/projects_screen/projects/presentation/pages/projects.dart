...
import 'package:manage_life_app/layout/projects_screen/projects/presentation/pages/archieved_projects.dart';
      ...
      builder: (context, state) {
        return Scaffold(
          ...
          appBar: AppBar(
            ...
            titleSpacing: 0,
            title: Text(AppLocalizations.of(context)!.projects, style: TextStyle(color: Colors.white),),
            actions: [
              ...
              InkWell(
                onTap: () => navigateTo(context, AechievedProjectsScreen()),
                child: IconButton(
                  onPressed: () {
                    navigateTo(context, AechievedProjectsScreen());
                  },
                  icon: Stack(
                    children: <Widget>[
                      ...
                      Positioned(
                        ...
                        child: Container(
                          ...
                          child: Text(
                            ProjectCubit.get(context).archivedProjects.length.toString(),
                            style: TextStyle(
                              color: mainColor,
                              fontSize: 8,
                            ),
          ...
          body: ProjectList(typeOfProjects: "allProjects"),
        );
      }
    );
  }
